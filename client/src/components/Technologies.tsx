    ...
    items: [
      ...
      { name: "LlamaIndex", icon: () => (
        <svg
          ...
          className="w-12 h-12"
        >
          <path d="M12 2c-1.5 0-2.7.3-3.6.9-.9.6-1.6 1.4-2 2.4-.4 1-.6 2.1-.6 3.2 0 1.2.2 2.3.7 3.3.4 1 1.1 1.8 1.9 2.4.8.6 1.8.9 2.8.9.7 0 1.4-.1 2-.4.6-.3 1.1-.7 1.5-1.2.4-.5.6-1.1.6-1.8 0-.8-.3-1.5-.8-2-.5-.5-1.2-.8-2-.8-.7 0-1.3.2-1.8.6-.5.4-.8.9-.8 1.5 0 .4.1.8.3 1.1.2.3.5.6.8.7.3.2.7.2 1.1.2.3 0 .6-.1.8-.2.2-.1.4-.3.5-.5.1-.2.2-.4.2-.7 0-.3-.1-.5-.3-.7-.2-.2-.4-.3-.7-.3" />
        </svg>
      )},
    ],
  },
