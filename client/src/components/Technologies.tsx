    ...
    items: [
      ...
      { name: "LlamaIndex", icon: () => (
        <svg
          ...
          className="w-12 h-12"
        >
          <path d="M6 17.5c0 .3-.2.5-.5.5s-.5-.2-.5-.5.2-.5.5-.5.5.2.5.5zM20 10c0-2.5-1.5-4.5-3.5-4.5S13 7.5 13 10c0 1.3.4 2.5 1.2 3.3-.3.3-.7.5-1.2.5-.8 0-1.5-.7-1.5-1.5V9c0-2.5-1.5-4.5-3.5-4.5S4.5 6.5 4.5 9c0 1.9.9 3.5 2.3 4.2.3.2.7.2 1 .1.3-.1.5-.3.7-.5.3-.5.5-1.1.5-1.8 0-.8-.3-1.5-.8-2-.5-.5-1.2-.8-2-.8-.7 0-1.3.2-1.8.6-.5.4-.8.9-.8 1.5 0 .4.1.8.3 1.1.2.3.5.6.8.7.3.2.7.2 1.1.2.3 0 .6-.1.8-.2.2-.1.4-.3.5-.5.1-.2.2-.4.2-.7 0-.3-.1-.5-.3-.7-.2-.2-.4-.3-.7-.3M19 12.7c-.3.3-.7.5-1.2.5-.8 0-1.5-.7-1.5-1.5V8c0-1.9.9-3.5 2.3-4.2.3-.2.7-.2 1-.1.3.1.5.3.7.5.3.5.5 1.1.5 1.8 0 .8-.3 1.5-.8 2-.5.5-1.2.8-2 .8-.7 0-1.3-.2-1.8-.6-.5-.4-.8-.9-.8-1.5 0-.4.1-.8.3-1.1.2-.3.5-.6.8-.7.3-.2.7-.2 1.1-.2.3 0 .6.1.8.2.2.1.4.3.5.5.1.2.2.4.2.7 0 .3-.1.5-.3.7" />
        </svg>
      )},
    ],
  },
