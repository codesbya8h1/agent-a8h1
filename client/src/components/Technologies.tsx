    ...
    items: [
      ...
      { name: "LlamaIndex", icon: () => (
        <svg
          ...
          className="w-12 h-12"
        >
          <path d="M5 19v-2c0-1.7 1.3-3 3-3h8c1.7 0 3 1.3 3 3v2H5zM12 3c1.3 0 2.6.5 3.5 1.5 1 1 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.5 3.5-1 1-2.2 1.5-3.5 1.5-1.3 0-2.6-.5-3.5-1.5-1-1-1.5-2.2-1.5-3.5 0-1.3.5-2.6 1.5-3.5C9.4 3.5 10.7 3 12 3z" />
        </svg>
      )},
    ],
  },
