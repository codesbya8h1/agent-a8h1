  ...
  },
  {
    ...
    icon: () => (
      <svg
        ...
        className="w-8 h-8"
      >
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 2c4.41 0 8 3.59 8 8s-3.59 8-8 8-8-3.59-8-8 3.59-8 8-8zm1 3H8v2h2v6H8v2h7v-2h-2V7z" />
      </svg>
    ),
